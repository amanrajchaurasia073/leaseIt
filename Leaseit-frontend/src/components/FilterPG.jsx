...
import DefaultPGView from './DefaultPGView';
...
function FilterPG() {
  ...
  const applyFilters = () => {
    return data.filter((item) => {
      return (
        (filters.pgType === "" || item.pgType === filters.pgType) &&
        (filters.sharingType === "" || item.sharingType === filters.sharingType) &&
    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <div className="grid grid-cols-1 text-teal-custom md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* PG Type Filter */}
          <div>
            <label className="block text-sm font-medium  text-teal-custom">PG Type</label>
            <select
              name="pgType"
            ...
            >
              ...
              <option value="Men's PG">Mens PG</option>
              <option value="Co-live PG">Co-live PG</option>
            </select>
          </div>

          {/* Sharing Type Filter */}
          <div>
            <label className="block text-sm font-medium  text-teal-custom">Sharing Type</label>
            <select
              name="sharingType"
